...
// var add = require('./modules/sum.js'); //sub folder and the module file
// console.log(add.AddNumber(1,2)); //

var add = require('./modules'); //sub folder only 

console.log(add.addtion(2,3)) //this approach req an index file

var add = require('./modules/index.js'); // sub folder and index file
